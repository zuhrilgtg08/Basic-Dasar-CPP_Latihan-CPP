...
void crud::writeData(std::fstream &data, int posisi, crud::Mahasiswa &inputMahasiswa){
	...
	int crud::getOption(){
		...
		//system("clear");
		 system("cls");
		std::cout << "\nProgram CRUD data crud::Mahasiswa" << std::endl;
		std::cout << "=============================" << std::endl;
		std::cout << "1. Tambah data crud::Mahasiswa" << std::endl;
		std::cout << "2. Tampilkan data crud::Mahasiswa" << std::endl;
		std::cout << "3. Ubah data crud::Mahasiswa" << std::endl;
		std::cout << "4. Hapus data crud::Mahasiswa" << std::endl;
